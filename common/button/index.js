...
const Button = ({
  ...
  return (
    <button
      ...
      type={type}
      className={`py-2 px-4 font-others   bg-primary min-h-10 hover:bg-secondary transition duration-300 ease-in-out text-white font-semibold flex items-center justify-center ${
